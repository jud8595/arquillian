...
public class HelloSimpleResourceAndInjectTest {	
    ...
    public void testSimple() throws InterruptedException {
        ...
        System.out.println("from testcase: " + str);
    	Assert.assertEquals("Hello, Resource. Service: simple", str);
    	Assert.fail("Simple Resource and Inject. Not yet implemented");
    }
}